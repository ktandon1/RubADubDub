...
public class HandwashingHound extends JFrame {
    ...
    public static void main(String[] args) { //main
        try {
            ...
            try {
                HandwashingHound bic = new HandwashingHound(waterZoneDir, waterLocationDir, noSoapHandsDir, testDir);
            } catch (Exception e) {
                e.printStackTrace();
            }
        } catch (Exception e) {
            System.out.println("\nUSAGE: java HandwashingHound [/path/to/waterzone/files] [/path/to/waterlocation/files] [/path/to/nosoaphands/dir] [/path/to/test/dir]");

        }
    }

    public HandwashingHound(String waterZoneDir, String waterLocationDir, String noSoapHandsDir, String testDir) {
